...
path = '/Users/nathanoliver/Desktop/Python/Github/Masirah Island/csv/wind_speed.csv'

df = read_file(path)

print(df.columns)

avg = sum(df['wind speed']) / len(df)

print(df['wind speed'])

standard = statistics.stdev((df['wind speed']))
...
ax.hist(df['wind speed'], **kwargs, color='blue',
