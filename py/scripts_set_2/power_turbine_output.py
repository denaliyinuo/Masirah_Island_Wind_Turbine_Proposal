...
path1 = '/Users/nathanoliver/Desktop/Python/Github/Masirah Island/csv/data_set_2/wind_speed.csv'
path2 = '/Users/nathanoliver/Desktop/Python/Github/Masirah Island/csv/data_set_2/turbine_power_coefficients.csv'
...
# print(df1['lower_wind_speed'].describe())
# print(df1['upper_wind_speed'].describe())
...
for i in range(len(df1)):
    ...
    print(lower_wind_speed_index)
    upper_wind_speed_index = determine_power_lower(wind_speed) + 1
    # upper_wind_speed_index = lower_wind_speed_index + 1
    ...
    # df1.to_csv(
    #     '/Users/nathanoliver/Desktop/Python/Github/Masirah Island/csv/data_set_2/wind_site_power_efficiency.csv')
